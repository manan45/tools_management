...
abstract class REST_Controller extends \CI_Controller {
    ...
    protected function _check_cors()
    {
        ...
        {
            header('Access-Tools-Allow-Origin: *');
            header('Access-Tools-Allow-Headers: '.$allowed_headers);
            header('Access-Tools-Allow-Methods: '.$allowed_methods);
        }
        else
        {
            ...
            // If the origin domain is in the allowed_cors_origins list, then add the Access Tools headers
            if (in_array($origin, $this->config->item('allowed_cors_origins')))
            {
                header('Access-Tools-Allow-Origin: '.$origin);
                header('Access-Tools-Allow-Headers: '.$allowed_headers);
                header('Access-Tools-Allow-Methods: '.$allowed_methods);
            }
        }
